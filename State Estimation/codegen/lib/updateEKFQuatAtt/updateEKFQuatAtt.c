...
static void updateEKFQuatAtt_init(void);
...
static void updateEKFQuatAtt_init(void)
{
  ...
  static const double dv5[7] = { 2.5E-9, 2.5E-9, 2.5E-9, 2.5E-9, 1.0E-12,
    1.0E-12, 1.0E-12 };

  static const double dv6[6] = { 0.0025000000000000005, 0.0025000000000000005,
