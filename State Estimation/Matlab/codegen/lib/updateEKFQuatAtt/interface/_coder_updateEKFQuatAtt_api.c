...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "updateEKFQuatAtt",                  /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void updateEKFQuatAtt_api(const mxArray * const prhs[7], int32_T nlhs, const
  mxArray *plhs[3])
{
  real_T (*gyr_rps)[3];
  real_T (*acc_mps2)[3];
  ...
  magDecRad = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "magDecRad");
  T = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "T");
  NdivT = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "NdivT");

  /* Invoke the target function */
  updateEKFQuatAtt(*gyr_rps, *acc_mps2, *mag_unit, Va_mps, magDecRad, T, NdivT,
...
void updateEKFQuatAtt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  updateEKFQuatAtt_xil_terminate();
  updateEKFQuatAtt_xil_shutdown();
...
/* End of code generation (_coder_updateEKFQuatAtt_api.c) */
