...
static void main_updateEKFQuatAtt2(void);
...
static void main_updateEKFQuatAtt2(void)
{
  ...
  /* Initialize function 'updateEKFQuatAtt2' input arguments. */
  ...
  /* Call the entry-point 'updateEKFQuatAtt2'. */
  updateEKFQuatAtt2(gyr_rps_tmp_tmp, gyr_rps_tmp_tmp, gyr_rps_tmp_tmp,
                    argInit_real_T(), argInit_real_T(), &roll_deg, &pitch_deg,
                    &yaw_deg, &yaw_mag_deg);
}
